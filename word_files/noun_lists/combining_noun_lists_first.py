with open("word_files/noun_lists/noun_list_first_combined.txt", "w", encoding = "utf-8") as output, open("word_files/noun_lists/noun_list_first_1.txt") as f1, open("word_files/noun_lists/noun_list_first_2.txt", encoding="utf8") as f2: 
