...
with open("word_files/medium_database/medium.xml","r", encoding="utf-8") as mdatabase, open("word_files/medium_database/medium_output.py","w", encoding="utf-8") as output:
    key = -1
